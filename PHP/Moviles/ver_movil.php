...
<head>
  ...
  <title>Mobile Sell - Ver móvil</title>
  <style>
  ...
  <script src="../../JavaScript/Moviles/mis_moviles.js"></script>
  ...
  <div class="container-fluid" id="contenedorVerMovil">
    ...
    <div class="row" id="tituloPagina">
        <div class="col-sm-12 d-flex justify-content-center">
            <h1 class="text-center">Ver móvil</h1>
        </div>
    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-12 col-md-6 ml-auto divCampos" id="divVenta">
              ...
              <div class="col-12">
                ...
                ?> type="checkbox" name="venta" class="form-control" id="venta" placeholder="¿Quiere vender el producto?">
              </div>
            </div>
